...
const badgeVariants = cva(
  'inline-flex items-center border-2 px-s py-xs text-xs font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        filled: 'border-foreground bg-foreground text-background shadow-sm',
      },
    },
    defaultVariants: {
      variant: 'default',
